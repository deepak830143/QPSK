...
![image](https://github.com/user-attachments/assets/f72fd7d4-80dd-4ff3-bd94-9361268d0b7c)

# Results:
Hence the modulation and demodulation of QPSK is obtained using python .
